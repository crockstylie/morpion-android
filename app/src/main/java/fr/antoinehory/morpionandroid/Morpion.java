...
public class Morpion extends AppCompatActivity implements View.OnTouchListener {
    ...
    private int taille;
    private final List<Pion> historique = new LinkedList<>();
    ...
    /** retourne vrai s'i 'il existe un pion en (x,y) et qu'il est
    ...
    /** Retourne vrai si un alignement de 5 existe pour le joueur courant.
