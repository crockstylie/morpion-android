package fr.antoinehory.morpionandroid;
...
public class Plateau extends View {
    ...
    private final Paint pLignes;
    private final Paint pCroix;
    private final Paint pRond;
    private final Paint pVainqueur;
    private final List<Pion> historique;
    ...
    protected void onDraw(@NonNull Canvas canvas) {
        ...
        if(solution!=null) {
            ...
            canvas.drawText(
                    "Vainqueur : "+((vainqueur)?"croix":"ronds"),
                    w/2,
                    h/2,
                    pVainqueur
            );
